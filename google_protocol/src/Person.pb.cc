...
void protobuf_AssignDesc_pb_2fPerson_2eproto() {
  protobuf_AddDesc_pb_2fPerson_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_pb_2fPerson_2eproto);
}
...
void protobuf_ShutdownFile_pb_2fPerson_2eproto() {
...
void protobuf_AddDesc_pb_2fPerson_2eproto() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "pb/Person.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_pb_2fPerson_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_pb_2fPerson_2eproto {
  StaticDescriptorInitializer_pb_2fPerson_2eproto() {
    protobuf_AddDesc_pb_2fPerson_2eproto();
  }
} static_descriptor_initializer_pb_2fPerson_2eproto_;
...
const Person_PhoneNumber& Person_PhoneNumber::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_pb_2fPerson_2eproto();
