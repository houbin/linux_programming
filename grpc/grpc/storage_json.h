...
extern grpcMethod_t storage_json_methodList[];

//--- account_get_users definition ----

typedef struct{
	int idle;
} PARAM_REQ_storage_json_account_get_users;
...
} PARAM_RESP_storage_json_account_get_users;
...
int USERDEF_RESP_storage_json_account_get_users(grpc_t *grpc);
...
typedef struct{
	...
	char *level; //admin,operator,user,anonymous,extended
	char *description; //This is Adiministrator
} PARAM_REQ_storage_json_account_add_user;

typedef struct{
	int idle;
} PARAM_RESP_storage_json_account_add_user;
...
int USERDEF_RESP_storage_json_account_add_user(grpc_t *grpc);

//--- account_del_user definition ----

typedef struct{
	char *name; //username
} PARAM_REQ_storage_json_account_del_user;

typedef struct{
	int idle;
} PARAM_RESP_storage_json_account_del_user;
...
int USERDEF_RESP_storage_json_account_del_user(grpc_t *grpc);
...
typedef struct{
	...
	char *level; //admin,operator,user,anonymous,extended
	char *description; //This is Adiministrator
} PARAM_REQ_storage_json_account_modify_user;

typedef struct{
	int idle;
} PARAM_RESP_storage_json_account_modify_user;
...
int USERDEF_RESP_storage_json_account_modify_user(grpc_t *grpc);

//--- channel_get definition ----

typedef struct{
	int idle;
} PARAM_REQ_storage_json_channel_get;
...
} PARAM_RESP_storage_json_channel_get;
...
int USERDEF_RESP_storage_json_channel_get(grpc_t *grpc);
...
typedef struct{
	int idle;
} PARAM_RESP_storage_json_channel_add;
...
int USERDEF_RESP_storage_json_channel_add(grpc_t *grpc);
...
typedef struct{
	...
	char *sid; //A361/N65465413
	char *protocol; //cloudsee/rtsp/onvif
} PARAM_REQ_storage_json_channel_remove;

typedef struct{
	int idle;
} PARAM_RESP_storage_json_channel_remove;
...
int USERDEF_RESP_storage_json_channel_remove(grpc_t *grpc);
...
typedef struct{
	...
	char *streamserverip; //127.0.0.1
	int streamserverport;
} PARAM_REQ_storage_json_channel_modify;

typedef struct{
	int idle;
} PARAM_RESP_storage_json_channel_modify;
...
int USERDEF_RESP_storage_json_channel_modify(grpc_t *grpc);

//--- broadcast_discovery definition ----

typedef struct{
	int idle;
} PARAM_REQ_storage_json_broadcast_discovery;
...
int USERDEF_RESP_storage_json_broadcast_discovery(grpc_t *grpc);
...
typedef struct{
	int idle;
} PARAM_REQ_storage_json_broadcast_get_inet;
...
} PARAM_RESP_storage_json_broadcast_get_inet;
...
int USERDEF_RESP_storage_json_broadcast_get_inet(grpc_t *grpc);
...
typedef struct{
	...
	char *gateway; //192.168.7.1
	char *dns; //202.102.128.68
} PARAM_REQ_storage_json_broadcast_eth_set;

typedef struct{
	int idle;
} PARAM_RESP_storage_json_broadcast_eth_set;
...
int USERDEF_RESP_storage_json_broadcast_eth_set(grpc_t *grpc);
...
typedef struct{
	...
	char *username; //qlc
	char *passwd; //123456
} PARAM_REQ_storage_json_broadcast_ppp_set;

typedef struct{
	int idle;
} PARAM_RESP_storage_json_broadcast_ppp_set;
...
int USERDEF_RESP_storage_json_broadcast_ppp_set(grpc_t *grpc);
...
} PARAM_REQ_storage_json_broadcast_wifi_connect;

typedef struct{
	int idle;
} PARAM_RESP_storage_json_broadcast_wifi_connect;
...
int USERDEF_RESP_storage_json_broadcast_wifi_connect(grpc_t *grpc);
...
typedef struct{
	GBOOL bResearch;
} PARAM_REQ_storage_json_broadcast_wifi_list_ap;
...
} PARAM_RESP_storage_json_broadcast_wifi_list_ap;
...
int USERDEF_RESP_storage_json_broadcast_wifi_list_ap(grpc_t *grpc);

//--- storage_get_info definition ----

typedef struct{
	int idle;
} PARAM_REQ_storage_json_storage_get_info;
...
} PARAM_RESP_storage_json_storage_get_info;
...
int USERDEF_RESP_storage_json_storage_get_info(grpc_t *grpc);

//--- storage_start_intial_disk definition ----

typedef struct{
	char *disk_str; //sdb
} PARAM_REQ_storage_json_storage_start_intial_disk;

typedef struct{
	char *disk_str; //sdb
	char *start_initial; //yes or no
} PARAM_RESP_storage_json_storage_start_intial_disk;
...
int USERDEF_RESP_storage_json_storage_start_intial_disk(grpc_t *grpc);

//--- storage_get_disk_initial_rate definition ----

typedef struct{
	char *disk_str; //sdb
} PARAM_REQ_storage_json_storage_get_disk_initial_rate;

typedef struct{
	char *disk_str; //sdb
	int rate;
} PARAM_RESP_storage_json_storage_get_disk_initial_rate;
...
int USERDEF_RESP_storage_json_storage_get_disk_initial_rate(grpc_t *grpc);
...
typedef struct{
	...
	int end_minute;
	int end_second;
} PARAM_REQ_storage_json_storage_get_record_fragments;
...
} PARAM_RESP_storage_json_storage_get_record_fragments;
...
int USERDEF_RESP_storage_json_storage_get_record_fragments(grpc_t *grpc);
...
int USERDEF_RESP_storage_json_stream_get_service(grpc_t *grpc);
#ifdef __cplusplus
}
#endif
#endif
